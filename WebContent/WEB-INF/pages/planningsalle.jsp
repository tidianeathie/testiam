...
<title>Gestion PlanningSalle</title>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="panel panel-default">
					<div class="panel-heading">Ajout d'un nouvel Planning Salle</div>
			...
			<div class="col-md-6">
				<div class="panel panel-default">
					<div class="panel-heading">Recherche d'un Planning Salle</div>
					<div class="panel-body">
			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">Liste des Planning Salles</div>
					<div class="panel-body">
